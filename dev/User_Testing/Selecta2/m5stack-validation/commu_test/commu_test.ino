...
byte data[8] = {0x01, 0x05, 0x00, 0xFF, 0xFF, 0x00, 0xBC, 0x0A};
...
char uart_buffer[9] = {0x01, 0x05, 0x00, 0xFF, 0xFF, 0x00, 0xBC, 0x0A};
char comchar;
char Num       = 0;
int Send_Count = 0;
int Send_OK    = 0;
...
void setup() {
    ...
    //  The 13(RX), 14(TX) pins of the CORE2 correspond to the 16(RX), 17(TX)
    //  pins of the COMX
    // Please make sure that the dialing switch of COMX is set to 16(RX),
    // 17(TX).
